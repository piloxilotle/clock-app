...
import 'contactuspage_copy_copy_copy_model.dart';
export 'contactuspage_copy_copy_copy_model.dart';

class ContactuspageCopyCopyCopyWidget extends StatefulWidget {
  const ContactuspageCopyCopyCopyWidget({super.key});

  @override
  State<ContactuspageCopyCopyCopyWidget> createState() =>
      _ContactuspageCopyCopyCopyWidgetState();
}

class _ContactuspageCopyCopyCopyWidgetState
    extends State<ContactuspageCopyCopyCopyWidget> {
  late ContactuspageCopyCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContactuspageCopyCopyCopyModel());
  }
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: Image.asset(
                                              'assets/images/Untitled53_20240428133706-1714282708327.png',
                                              width: 401.0,
                                              height: 882.0,
                                              fit: BoxFit.cover,
                                            ),
