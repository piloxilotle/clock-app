...
import 'contactuspage_copy_model.dart';
export 'contactuspage_copy_model.dart';

class ContactuspageCopyWidget extends StatefulWidget {
  const ContactuspageCopyWidget({super.key});

  @override
  State<ContactuspageCopyWidget> createState() =>
      _ContactuspageCopyWidgetState();
}

class _ContactuspageCopyWidgetState extends State<ContactuspageCopyWidget> {
  late ContactuspageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ContactuspageCopyModel());
  }
                              ...
                              children: [
                                Stack(
                                  children: [
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(8.0),
                                                        child: Image.asset(
                                                          'assets/images/Untitled53_20240428133220-1714282538692.png',
                                                          width: 401.0,
                                                          height: 882.0,
                                                          fit: BoxFit.cover,
                                                        ),
                                    ...
                                    Align(
                                      alignment:
                                          const AlignmentDirectional(0.66, 0.08),
